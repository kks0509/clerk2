...
export default function Home() {
  return (
    <>
      <h5 className="text-2xl mb-4 font-bold">Welcome Home</h5>
      ...
      <div className="mb-4 bg-gray-100 p-4 m-4 rounded-lg">
        ...
        <p className="mb-2">
          GitHub is widely available as a tool to facilitate open-source project
          hosting and collaboration among developers.
        </p>
      </div>
      ...
      <div className="mb-4 bg-gray-100 p-4 m-4 rounded-lg">
        ...
        <p className="mb-2">Go to my GitHub repertoire.</p>
      </div>
    </>
  );
}
